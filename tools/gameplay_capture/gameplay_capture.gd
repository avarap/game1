...
const STEPS: Array[Dictionary] = [
	...
	{"kind": &"move", "target": Vector2(1272, 570), "run": false, "tolerance": 8.0, "label": "Approach grave upgrade"},
	...
	{"kind": &"move", "target": Vector2(1468, 800), "run": true, "tolerance": 8.0, "label": "Approach forest exit"},
