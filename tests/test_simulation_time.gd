...
static func run() -> Array[String]:
    ...
    if int(time_manager.get("day")) != 7 or int(time_manager.get("hour")) != 0 or int(time_manager.get("minute")) != 10:
    ...
    if energy == null:
        ...
        if sleep_spot is SleepSpot:
            ...
            if int(time_manager.get("day")) != 4 or int(time_manager.get("hour")) != 6 or int(time_manager.get("minute")) != 0:
    ...
    if not bool(save_manager.call("save_game", save_path, {"test": {"ok": true}})):
        ...
        if int(time_manager.get("day")) != 9 or int(time_manager.get("hour")) != 21 or int(time_manager.get("minute")) != 45:
