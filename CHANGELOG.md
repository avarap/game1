...
- `HISTORIA_PRINCIPAL.md` con la propuesta narrativa completa **El Cementerio de Valdeniebla**.
...
- `ROADMAP.md` prioriza el Acto 1 de Valdeniebla durante Fase 6; Actos 2/3 no adelantan alcance de fases posteriores.
...
- Integración narrativa: `cf1e6fbaa6f562ca4d3a005496354ac996168ace` añade `HISTORIA_PRINCIPAL.md`.
- Condiciones narrativas: `e1a19343e8303d1b28188a2a38c559d788c8087d`, run `33299990183`, `gdscript-quality` y `validate-and-test` en `success`.
