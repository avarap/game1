...
const MAIN_ROUTE_SHOULDERS := [
	Vector2i(13, 24), Vector2i(14, 24), Vector2i(16, 24), Vector2i(17, 23),
	Vector2i(19, 23), Vector2i(20, 22), Vector2i(23, 21), Vector2i(24, 20),
	Vector2i(27, 19), Vector2i(28, 18), Vector2i(30, 17), Vector2i(32, 16),
	Vector2i(34, 16), Vector2i(36, 18), Vector2i(39, 21), Vector2i(41, 23),
	Vector2i(42, 23), Vector2i(44, 23), Vector2i(46, 23),
]
...
const VILLAGE_ROUTE_EDGES := [
	Vector2i(23, 17), Vector2i(25, 15), Vector2i(23, 13), Vector2i(25, 10),
	Vector2i(23, 8), Vector2i(25, 6), Vector2i(23, 4),
]
...
const CEMETERY_LOOP_SHOULDERS := [
	Vector2i(30, 15), Vector2i(30, 13), Vector2i(32, 13), Vector2i(33, 12),
	Vector2i(35, 10), Vector2i(37, 9), Vector2i(39, 9), Vector2i(40, 10),
	Vector2i(42, 12), Vector2i(43, 14), Vector2i(41, 15), Vector2i(40, 18),
]

const WORKSHOP_APRON := [
	Vector2i(9, 22), Vector2i(10, 22), Vector2i(11, 22), Vector2i(12, 22),
	Vector2i(13, 22), Vector2i(14, 22), Vector2i(15, 22), Vector2i(16, 22),
	Vector2i(9, 23), Vector2i(10, 23), Vector2i(11, 23), Vector2i(12, 23),
	Vector2i(17, 23), Vector2i(9, 24), Vector2i(10, 24), Vector2i(11, 24),
	Vector2i(12, 24), Vector2i(13, 24), Vector2i(15, 24), Vector2i(16, 24),
	Vector2i(17, 24), Vector2i(10, 25), Vector2i(11, 25), Vector2i(12, 25),
	Vector2i(14, 25), Vector2i(15, 25), Vector2i(16, 25),
]

const CEMETERY_WORN_PATCHES := [
	Vector2i(32, 11), Vector2i(34, 11), Vector2i(36, 10), Vector2i(38, 10),
	Vector2i(40, 12), Vector2i(33, 13), Vector2i(35, 13), Vector2i(38, 13),
	Vector2i(41, 14), Vector2i(32, 15), Vector2i(36, 15), Vector2i(39, 16),
	Vector2i(41, 17), Vector2i(37, 18),
]

const PATH_BREAKUP_CELLS := [
	Vector2i(15, 23), Vector2i(18, 22), Vector2i(22, 20), Vector2i(26, 18),
	Vector2i(30, 16), Vector2i(35, 16), Vector2i(38, 19), Vector2i(43, 22),
	Vector2i(24, 12), Vector2i(24, 7), Vector2i(34, 10), Vector2i(39, 10),
]

const GROUND_DRY_CELLS := [
	Vector2i(7, 21), Vector2i(8, 22), Vector2i(9, 21), Vector2i(10, 20),
	Vector2i(12, 20), Vector2i(14, 21), Vector2i(16, 20), Vector2i(17, 21),
	Vector2i(8, 25), Vector2i(10, 26), Vector2i(13, 26), Vector2i(16, 26),
	Vector2i(18, 24), Vector2i(18, 27),
]

const GROUND_COMPACTED_CELLS := [
	Vector2i(11, 21), Vector2i(13, 21), Vector2i(15, 21), Vector2i(17, 23),
	Vector2i(9, 25), Vector2i(12, 25), Vector2i(15, 25), Vector2i(17, 25),
	Vector2i(19, 22), Vector2i(20, 21), Vector2i(22, 20), Vector2i(25, 19),
]

const GROUND_MOSS_CELLS := [
	Vector2i(31, 6), Vector2i(33, 5), Vector2i(35, 6), Vector2i(38, 5),
	Vector2i(41, 6), Vector2i(32, 8), Vector2i(34, 9), Vector2i(38, 8),
	Vector2i(42, 9), Vector2i(30, 11), Vector2i(43, 11), Vector2i(44, 14),
	Vector2i(32, 18), Vector2i(35, 19), Vector2i(42, 18),
]

const GROUND_WET_CELLS := [
	Vector2i(44, 19), Vector2i(46, 18), Vector2i(47, 20), Vector2i(43, 22),
	Vector2i(45, 23), Vector2i(47, 24), Vector2i(42, 25), Vector2i(44, 26),
	Vector2i(46, 27), Vector2i(40, 24), Vector2i(41, 26),
]

const GROUND_DISTURBED_CELLS := [
	Vector2i(33, 7), Vector2i(36, 6), Vector2i(39, 7), Vector2i(32, 10),
	Vector2i(35, 10), Vector2i(38, 11), Vector2i(41, 10), Vector2i(34, 13),
	Vector2i(37, 14), Vector2i(40, 13), Vector2i(34, 16), Vector2i(37, 17),
	Vector2i(40, 16),
]

const GROUND_NORTH_CELLS := [
	Vector2i(20, 3), Vector2i(22, 4), Vector2i(25, 3), Vector2i(26, 5),
	Vector2i(21, 7), Vector2i(23, 8), Vector2i(26, 9), Vector2i(20, 10),
	Vector2i(22, 12), Vector2i(25, 13),
]

const GROUND_ERODED_CELLS := [
	Vector2i(18, 21), Vector2i(21, 20), Vector2i(23, 19), Vector2i(27, 17),
	Vector2i(29, 16), Vector2i(32, 14), Vector2i(35, 15), Vector2i(37, 18),
	Vector2i(40, 20), Vector2i(42, 21), Vector2i(45, 21),
]
...
const GRAVE_TILES := [
	Vector2i(0, 3), Vector2i(2, 3), Vector2i(1, 3), Vector2i(3, 3),
	Vector2i(0, 3), Vector2i(3, 3), Vector2i(1, 3), Vector2i(2, 3),
	Vector2i(3, 3), Vector2i(0, 3), Vector2i(2, 3), Vector2i(1, 3),
	Vector2i(3, 3),
]
...
const LOW_DECOR_TILES := [
	Vector2i(0, 2), Vector2i(3, 2), Vector2i(1, 2), Vector2i(6, 2),
	Vector2i(2, 2), Vector2i(5, 2), Vector2i(7, 2), Vector2i(1, 2),
	Vector2i(4, 2), Vector2i(0, 2), Vector2i(6, 2), Vector2i(3, 2),
	Vector2i(7, 2), Vector2i(2, 2), Vector2i(5, 2), Vector2i(1, 2),
]

const BOULDER_CELLS := [
	Vector2i(7, 10), Vector2i(28, 11), Vector2i(43, 19),
]
const TIMBER_CELLS := [
	Vector2i(14, 17), Vector2i(19, 27),
]
const BRAMBLE_CELLS := [
	Vector2i(29, 15),
]
...
const FOREGROUND_VARIANT_0 := [
	Vector2i(4, 3), Vector2i(31, 3), Vector2i(9, 30),
]
const FOREGROUND_VARIANT_2 := [
	Vector2i(8, 2), Vector2i(43, 3), Vector2i(32, 30),
]
const FOREGROUND_VARIANT_4 := [
	Vector2i(13, 3), Vector2i(47, 5), Vector2i(39, 29),
]
const FOREGROUND_VARIANT_6 := [
	Vector2i(18, 2), Vector2i(37, 2), Vector2i(4, 29), Vector2i(46, 28),
]
